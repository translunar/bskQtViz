...
IpAddressDialog::IpAddressDialog(QWidget *parent) :
    QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint), // flag for not having What's This button
...
QString IpAddressDialog::getIpAddress()
{
    return ui->ipAddress->text();
}

QString IpAddressDialog::getPort()
{
    return ui->port->text();
}
